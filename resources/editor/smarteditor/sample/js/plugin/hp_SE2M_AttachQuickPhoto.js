...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	$ON_ATTACHPHOTO_OPEN_WINDOW : function(){			
		this.htPopupOption.sUrl = this.makePopupURL(this.oApp.customParams);

		// 만들 팝업창 좌우 크기의 1/2 만큼 보정값으로 빼주었음
		var popupX = (window.screen.width / 2) - (403 / 2);
		var popupY= (window.screen.height /2) - (359 / 2);

		this.htPopupOption.sProperties = "left=" + popupX + ",top=" + popupY + ",width=403,height=359,scrollbars=yes,location=no,status=0,resizable=no";
	...
	makePopupURL : function(params){
		...
		return "./sample/photo_uploader/photo_uploader.html?" + data.slice(0, -1);		
	},
